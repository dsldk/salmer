<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs tei" version="2.0">
    ...
    <!-- Level 4 head -->
    <xsl:template match="tei:front/tei:div/tei:div/tei:div/tei:div/tei:head | tei:body/tei:div/tei:div/tei:div/tei:div/tei:div/tei:head | tei:back/tei:div/tei:div/tei:div/tei:div/tei:head">
        <xsl:choose>
            <xsl:when test="@type = 'add'">
			<!--<h4 class="metadata">
                    <xsl:apply-templates/>
    ...
    <!-- Level 5 head -->
    <xsl:template match="tei:front/tei:div/tei:div/tei:div/tei:div/tei:div/tei:head | tei:body/tei:div/tei:div/tei:div/tei:div/tei:div/tei:div/tei:head | tei:back/tei:div/tei:div/tei:div/tei:div/tei:div/tei:head">
        <xsl:choose>
            <xsl:when test="@type = 'add'">
			<!--<h4 class="metadata">
                    <xsl:apply-templates/>
