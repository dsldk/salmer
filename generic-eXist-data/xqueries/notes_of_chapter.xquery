...
let $notes := if ($chapter !=0 and $section != 0) then            
                  $xmldoc//tei:body/tei:div[$chapter]/tei:div[$section]//tei:ref[@type='note']
              else if ($chapter !=0) then
                  $xmldoc//tei:body/tei:div[$chapter]//tei:ref[@type='note']
              else $xmldoc//tei:body//tei:ref[@type='note']
return
    <results>
	   {$notes}
	</results>
